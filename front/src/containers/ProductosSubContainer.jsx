                                ...
                                <div key={product.id} className="col-md-3 col-sm-6">
                                    <span className="thumbnail">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-6 col-sm-6">
                                                <a href="" target="_blank" ><button className="glyphicon glyphicon-shopping-cart btn btn-info right" onClick={() => { var obj = { q: 1, id: product.id }; this.props.addToCart(obj); setTimeout(() => { localStorage.setItem("cart", JSON.stringify(this.props.cart)); }, 10); }} > </button></a>
