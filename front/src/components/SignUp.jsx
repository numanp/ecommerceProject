                    ...
                    <h1>Sign Up</h1>
                        <div className="loginForm">
                            ...
                            <div className="form-group">
                                ...
                                <input onChange={(e) => this.nombreChange(e)} type="text" name="ombre" placeholder="Nombre" className="form-control" /><br /><br />
                            </div>
                            <div className="form-group">
                                <label htmlFor="nombre">Apellido</label>
                                <input onChange={(e) => this.apellidoChange(e)} type="text" name="apellido" placeholder="Apellido"  className="form-control"/><br /><br />
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                ...
                                <input onChange={(e) => this.telefonoChange(e)} type="text" name="telefono" placeholder="Telefono" className="form-control"/><br /><br />
